...
**Guerra, sacrificio, ausencia y decisión de salir.** La Guerra de los Tres pertenece principalmente a este libro.
...
## Estado de salida (fijado por la estructura de trilogía)
...
La frase es verdadera y su significado queda deliberadamente abierto (Elenna, Chiara, la familia, o algo aún desconocido para el lector). Héctor tampoco conoce la verdad en esta escena.

Calibración tonal completa de este capítulo (referencias de temperatura emocional, ritmo, silencio, contraste ternura/pérdida — **no diegéticas: no se citan canciones ni se describe música dentro de la prosa**): [[12_Craft_Policies/tonal_calibration/Revelacion_Exilio_Elenna|Calibración musical — Revelación del exilio de Elenna]].
...
### La lista creciente de amenazas
...
> **CANON DEL AUTOR (2026-09-11).**

Cuando la cronología alcanza otra vez el nacimiento, se muestra la progresión completa que el Capítulo 1 dejó incompleta:

> nacimiento → pertenencia → separación → entrega → vacío → duelo público → duelo privado → vida clandestina.

Las mismas imágenes del Capítulo 1 pueden repetirse; ahora significan otra cosa. El Capítulo 1 funciona como **cicatriz narrativa** cuyo contexto se reconstruye progresivamente.

### Primer año de Elenna
...
Arresto por vía legal (caso construido por Lucia Varek). La ciudad puede leerlo como el centro del problema por fin identificado. Su caída **elimina un dique territorial** con el que Il Consorzio tenía incentivo para negociar: abre un vacío. Il Consorzio ya existía y ya presionaba antes; lo que cambia es su libertad para reorganizar u ocupar.

### Clímax real — la operación final de Halbrook
...
- No abrir en guerra total.
- Elenna no es un *stake* que deba estar físicamente en peligro para mover la trama.
- No reducir el libro a "derrotar al malo para salvar a la bebé".
- El ejército completo no es cómplice de Halbrook: corrompe y redirige partes de una infraestructura legítima.
- El arresto de Dario debe sentirse enorme porque su fachada seguía funcionando.
- No usar a Corrado para resolver el ocultamiento de Elenna.

## Pendientes (de [[00_Biblia/00_Trilogy_Structure]] y [[06_Relationships/Hitos]])

- Detonante concreto que obliga a fingir la muerte de Elenna.
- Mecanismo médico / documental / logístico de Elenna Serra.
- Duración exacta de la separación (trabajo: ~1 año, hasta los primeros pasos).
- Momento exacto de H22 dentro del libro, más allá de sus anclas relativas.
- Mecanismo y evidencia de la caída legal de Dario.
- Motivo exacto de la presencia de Chiara y Kenji en Santa Lucía.
- Relación causal y orden fino de Santa Lucía + montaña.
- Causa, posición y pago relacional de la muerte de Héctor.
