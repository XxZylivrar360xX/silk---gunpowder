...
El generador esta en `tools/epub-build/build_epub.py`. Mientras no existan capitulos de prosa, el EPUB se arma con `00_Front_Matter/00_Nota_Editorial.md` como maqueta de lectura. Cuando se agreguen capitulos en las partes, el script los incluira por orden de carpeta y nombre de archivo.
