...
*Ficha de Lugar — DISEÑO (2026-09-09), sobre el beat sembrado en [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/11_El_Farol|Cap. 12]] y la escena de [[11_Books/Book_01_Seda_y_Polvora/Part_02_Con_Peores_Personas_He_Tratado/26_Me_Encuentro_Bien|Cap. 27]]. Registra lo definido y marca lo que falta.*
...
Una nave de ladrillo y estructura de madera, techo alto, con las marcas en el piso de dónde estuvieron las tolvas de grano. Ahora: el alambique de cobre en un extremo, sacos, una hilera de barricas de roble nuevo contra la pared larga, un banco de trabajo, cajas de botellas listas para el reparto y una camioneta afuera sobre la grava.

Tres detalles para que vuelvan:

- **El olor** — maíz cocido y madera nueva encima, y por debajo el del edificio viejo, a sótano que nunca termina de secarse.
- **Las etiquetas pegadas a mano** — la impresora "ya va a llegar"; mientras, Walt las pega él, y corta las torcidas con la uña del pulgar.
- **El silencio de trabajo** — Walt no pone música ni habla de más. Se oye el goteo del alambique y poco más.
...
La destilería no es un "lugar donde se da información". Como La Esquina de Mabel, lo que se sepa aquí aparece como rutina de trabajo — una queja sobre un lote, una etiqueta torcida, una entrega que se atrasa — nunca como que alguien "viene a contar algo".

## Conexiones

- [[02_Characters/Walter_Keegan]] — dueño; su primer proyecto legítimo tras la cárcel.
- [[02_Characters/Chiara_Bellandi]] — lo ayudó a comprarla; el Monarch es el cliente ancla.
- [[03_Factions/El_Casino]] — cliente de suministro de licor.
- [[05_Locations/La_Esquina_de_Mabel]] — el otro nodo civil de La Almendra; misma regla de escritura.
- [[02_Characters/Silas_Crowe]] — el hombre que le costó a Walt diez años; que Walt tenga ahora algo propio y en regla es, en sí mismo, un problema para el Tasador (ver ficha de Walt).
...
Ver también: [[02_Characters/Walter_Keegan]] · [[03_Factions/El_Casino]] · [[02_Characters/Chiara_Bellandi]] · [[06_Relationships/Hitos]]
