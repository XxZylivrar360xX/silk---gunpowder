# Pendientes de autor — saga post-trilogía

> **ESTADO:** preguntas abiertas. Claude no debe cerrarlas por elegancia ni inferencia.
...
- Qué sabía exactamente Keene y qué parte fue omisión/corrupción.
...
- Si la entrevista ocurre en Libro 2 o en el tramo final del primero.

## Elenna

- Duración de academia y transición a patrulla.
- Si el disparo ocurre en el primer libro o más tarde.
- Especialidad futura, si alguna.
- Momento exacto en que deja de vivir con Marisol y alquila departamento.
- Cómo se presenta públicamente su parentesco con Kal/Chiara, dado que la historia pública de su nacimiento incluía una muerte.

## Riley / Marisol

- Escena exacta donde Elenna les anuncia la academia.
- Hasta qué punto Marisol debe recusarse o levantar barreras formales en un caso conectado a Elenna.
- Qué conflicto específico hace que Riley y Elenna discutan por sobreprotección.

## Cameos Kal / Chiara

- Qué identidades/cobertura utilizan para viajar a San Aurelio sin activar atención de Meridian.
- Qué conversación exacta tienen Kal y Nicholas en la despedida.
- Duración total del cameo para que sea pago emocional sin secuestrar la novela.
