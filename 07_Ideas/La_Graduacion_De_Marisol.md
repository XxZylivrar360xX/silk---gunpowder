# La graduación de Marisol — boceto de escena
...
—**Sei bellissima** —dice, con el acento americano tropezándose en cada sílaba.

*(Prosa completa del beat ya redactada — ver conversación del 2026-08-30. Lista para usarse casi sin edición cuando se escriba el capítulo.)*
...
Guardó cada detalle sin decidir guardarlo — el mismo instinto que usaba para memorizar una matrícula o una cara, puesto ahora al servicio de algo sin ninguna utilidad táctica —, mientras la memoria le devolvía, sin que se lo pidiera, la primera vez: la marquesina, el cigarro, los tacones rojos tocando el suelo como si el mundo entero hubiera sido puesto ahí para medir su ruido.

Bajó a abrirle la puerta antes de que el valet pudiera llegar primero.

—Sei bellissima —dijo, con el acento americano tropezándose en cada sílaba, torpe y sincero a la vez.

---

## Pendiente de construir

> **PENDIENTE:** el resto de la escena — la llegada a la ceremonia, el encuentro Marisol/Chiara (primera vez que se ven en persona), reacciones de ambas, y el cierre. Se irá añadiendo por partes en conversación con el autor.

> **PENDIENTE:** ubicación exacta de la ceremonia, y si el "lugar donde la vio por primera vez" implica que la recogida es literalmente en el Monarch (confirmado por el autor) — el matiz de que H2 fue bajo la marquesina, no en una escalera, queda anotado pero sin resolver si importa.
