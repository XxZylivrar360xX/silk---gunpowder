# Ledger de Revelaciones - Saga / Nivel Global

Misterios o verdades que cruzan todo *Seda y Polvora* o que no pertenecen a un solo libro.
...
- **Estado al inicio:** la redada y ausencia de Corrado pesan sobre Chiara. Aplicado en prosa por primera vez en [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/25_Libros_Abiertos|Cap. 26]] (jacuzzi/H15). Pendiente reconciliar las escenas heredadas que presuponen cuerpo retenido y el punto exacto del reveal a Kal (coda del Libro II).
...
## La verdad completa de Alessio Lusardi

- **Que es:** Chiara apuñalo a Alessio y Alessio murio. La version oficial la salvo. Los motivos y hechos exactos siguen pendientes y delicados.
...
- **Quien NO debe saberlo/insinuarlo todavia:** Kal al inicio; el lector no debe recibir motivos inventados; Tommaso no debe confirmar conocimiento si no esta decidido.
...
- **Capa permitida antes de la revelacion (2026-08-28):** el Capitulo 8 ([[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/09_El_Corral]]) establece, sin nombrar el homicidio, que Alessio le hizo mucho daño y que el mundo no la escucho — "un infierno que vivio en Roma". Esto es abuso confirmado, no el dato de quien lo mato.
...
- **Qué es:** Kal encuentra, escondida en un conducto de aire de la casa de sus padres, una caja de madera con algo grabado en runas nórdicas — la única herencia real que tiene de su vida antes de ser comprado de bebé. Complementa, no reemplaza, la pulsera de hospital ya establecida en [[02_Characters/Kal_Mercer]] como "lo único que puede ser real".
- **Se siembra en:** [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/10_El_Loft_Del_Soltero]] — no se abre en la escena. Kal la guarda en el maletero, debajo de una manta.
- **Quién ya lo sabe:** solo Kal. Ni el lector ni Chiara ven el contenido.
- **Quién NO debe saberlo/insinuarlo todavía:** nadie. La caja no vuelve a mencionarse hasta la Parte 3.
- **Líneas o gestos prohibidos:** abrir la caja, traducir las runas, o siquiera mencionarla de pasada antes de la Parte 3. Ni Kal debe pensar en ella entre medias — el silencio narrativo es parte del efecto.
