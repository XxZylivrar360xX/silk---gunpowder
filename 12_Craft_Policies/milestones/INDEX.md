# Indice de Momentos Hito

Indice cronologico de beats donde un personaje, relacion o mapa de poder cambia de forma irreversible. No reemplaza [[06_Relationships/Hitos]]; apunta a el y registra el orden de uso para prosa.

## Como usar

Antes de escribir una escena que dependa de "esto ya paso" o "todavia no paso", revisar esta lista.

Si una escena nueva cambia de forma irreversible una relacion, deuda, ritual o jerarquia, agregarla aqui con enlace.
...
5. [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/04_Tarifa_Nocturna]] - Blake exhibe a Chiara en La Isla; Matteo pide ayuda por un cliente vetado; Chiara llama a Kal; Kal resuelve el primer favor bajo la mesa con el Mercedes de Varga.
6. [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/05_La_Casa_No_Quiere_Ruido]] - Capitulo "Una amiga" (fusion de los antiguos Caps. 5+6, 2026-09-10, BLOQUE 2 de la cirugia editorial de Parte I). La factura de Kal es ensenable; la cadena de favores se vuelve metodo; Chiara aprende a elegir cuando llamarlo; Tommaso roza el pasado de Alessio; H2-a en prosa: primera cena que ninguno llama cita; Rocco, camioneta rentada, terraza de Il Gelsomino, Nadir/Danny como testigos. *(Numeracion 7 vacante hasta la renumeracion global — el antiguo Nota_Una_Amiga_Fusionada.md queda como nota de redireccion.)*
8. [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/06_Ambos]] - H2-b en prosa: nace la costumbre de contarse el dia; penthouse, hamburguesas, hierba, canciones, calavera, habitaciones separadas, primer tu y choque de punos.
...
24-a. [[06_Relationships/Hitos#H21 — Mi pareja]] - formalización verbal; dejan de ser "esto" y pasan a tener nombre. **Posición canon actualizada (2026-09-20, renumerado en cascada el mismo día):** cierra la Parte II, Cap. 34 (BORRADOR, escrito 2026-09-20) — ver [[11_Books/Book_01_Seda_y_Polvora/Part_02_Con_Peores_Personas_He_Tratado/34_Mi_Pareja]]. Puesto 15 de la tabla de orden, inmediatamente después de "La periferia" (Cap. 33) y antes de H16 — el cumpleaños/mudanza, que ahora abre la Parte III — Ardizzone (Cap. 35).
...
28. [[06_Relationships/Hitos#H13 — El pañuelo]] - intercepcion de Il Consorzio en la iglesia; planta el viaje a Palermo. *(Posicion fijada 2026-08-29: puesto 16 de la tabla de orden, justo antes de H17 — Italia. Ahora puesto 17 tras el adelanto de H21 — ver `06_Relationships/Hitos.md`.)* **Escrito (2026-09-20) como recuerdo dramatizado dentro de [[11_Books/Book_01_Seda_y_Polvora/Part_03_Ardizzone/38_Al_Reves|Cap. 38 — Al revés]], BORRADOR; el mismo capítulo paga Roma Atrii, revela el piano de Kal (*Träumerei*) y activa H17 ("Voy contigo") sin escribir Palermo. Contradicción de orden con F1 registrada en `PENDING.md`.**
...
> **Corregido 2026-09-11:** esta lista tenía a H22 en una sección "Parte IV" posterior al macrohito de la caída de Dario/Santa Lucía/Halbrook. [[00_Biblia/00_Trilogy_Structure]] fija el orden contrario — H22 va **antes** de ese macrohito, dentro del mismo libro. No existe una "Parte IV" separada para estos eventos.
