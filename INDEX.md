...
**Carpetas del Libro I (migración de nomenclatura, 2026-09-12):** `Part_01_Dos_Mundos/` (C01–C26), `Part_02_Con_Peores_Personas_He_Tratado/` (C27–C29), `Part_03_Ardizzone/`, `Part_04_Nieve_Y_Ceniza/`, `Part_05_Exilio/`, `Part_06_Torna_A_Casa/` y `Epilogue_La_Tierra_Bajo_Sus_Botas/`. Las últimas cinco están sin capítulos; `00_Front_Matter/` se conserva. Títulos y división vigente: [[01_Timeline/02_Cadena_De_Eventos_Libro_I#Partes del Libro I — títulos del autor]]. Sin redistribución de prosa ni reconciliación del Book Map.
...
- [[01_Timeline/02_Cadena_De_Eventos_Libro_I]] — **roadmap del Libro I desde el Cap. 26 hasta H1 + reveal + coda de Halbrook**: cadena de eventos, línea de tiempo anclada, fricciones que fortalecen la pareja, siembras hacia *Voto de Ceniza* y boceto de capítulos de las Partes II–VI y epílogo. **Títulos del autor (2026-09-10):** Dos Mundos · "Con peores personas he tratado" · Ardizzone · Nieve y Ceniza · Exilio · "Torna a Casa" · La tierra bajo sus botas. Cortes futuros: DISEÑO.
