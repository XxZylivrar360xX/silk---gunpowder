...
> **PENDIENTE:** definirla sin exotizarla. Su nacionalidad es dato de origen y red, no decoración.
...
- En [[06_Relationships/Momentos_de_Fractura]], F2, es ejecutada por una filtración real — no una duda sin fondo — y su muerte se convierte en la frontera moral que marca el ascenso de El Patio.

### CANON DEL AUTOR (2026-09-20) — origen de la filtración

Antes de integrarse del todo a El Patio, [[02_Characters/Tommaso_Lusardi|Tommaso Lusardi]] la encuentra y la usa como fuente informal sobre el norte: corredores, rutas, quién trabaja para quién. Mei-Lin acepta — todavía no confía en nada nuevo y una fuente extranjera que paga por gossip de calle no le parece distinto de lo que ya conocía en su antigua banda.
...
- **No es "la china" en voz del narrador.** Si alguien usa una etiqueta racial, eso caracteriza a quien la dice, no a Mei-Lin.
- **No entra como subordinada agradecida.** Llega con experiencia, sospecha y valor propio.
...
- [[02_Characters/Riley_Bennett]] — entra con ella desde la banda rival desintegrada; terminan viviendo juntas como roommates en La Almendra y esa convivencia se vuelve amistad real, no sólo procedencia compartida.
...
- [[02_Characters/Chiara_Bellandi]] — pendiente de definir. Chiara puede detectar en Mei-Lin una fuente de inteligencia sobre bandas rivales.
- [[03_Factions/Almendra_Towing]] — nueva casa operativa, si decide quedarse.
- [[02_Characters/Tommaso_Lusardi]] — la recluta como fuente informal antes de que Varek lo elimine.
- [[02_Characters/Dario_Varek]] — absorbe la línea de inteligencia de Tommaso y la convierte en su fuente pasiva dentro de El Patio.
- [[02_Characters/Nadir_Amrani]] — quien finalmente la ejecuta en F2.

---

## Preguntas abiertas

> **PENDIENTE:** nombre de la banda rival y por qué se desintegró.

> **RESUELTO (2026-09-20):** Mei-Lin y Riley terminan siendo roommates en La Almendra — al principio por conveniencia (mismo derrumbe, espacio limitado que ofrece Kal), después por amistad real construida en la convivencia diaria.

> **PENDIENTE:** qué conserva Mei-Lin de su antigua banda.

> **RESUELTO (2026-09-20):** quién la busca después de integrarse — primero [[02_Characters/Tommaso_Lusardi|Tommaso]], después, tras su muerte, [[02_Characters/Dario_Varek|Varek]] directamente (ver "origen de la filtración", arriba).

> **RESUELTO (2026-09-20):** sí traiciona realmente — entrega información real a Varek — pero por coerción/miedo, no por convicción ni plan de infiltración desde el origen; con el tiempo llega a querer sinceramente a la gente de El Patio. Ver "origen de la filtración", arriba.

> **PENDIENTE, no inventar todavía:** qué información exacta entrega Mei-Lin a Varek, y qué hecho concreto permite a Kal/El Patio descubrir la filtración. No hace falta para escribir los primeros capítulos de Parte III; sí antes de llegar a F2 en Parte V.

---

Ver también: [[02_Characters/Riley_Bennett]] · [[03_Factions/Almendra_Towing]]
