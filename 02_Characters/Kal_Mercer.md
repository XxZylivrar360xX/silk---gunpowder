...
Alto, uno noventa y tantos de esos que se notan en los marcos de las puertas. Rubio, ojos azules de un tono lavado, mandíbula ancha y rasgos nórdicos que vienen de su verdadero origen noruego, aunque su vida pública no tenga cómo nombrarlo. Cuerpo de trabajo físico, no de gimnasio: hombros de levantar cosas, manos con las uñas imposibles de dejar limpias del todo. **Una cicatriz le cruza la mejilla izquierda desde la comisura de la boca hasta el rabillo del ojo** (canon; ver [[06_Relationships/Hitos]], "La noche del jacuzzi"). Es lo primero que la gente le mira y lo último que le pregunta. **CONFIRMADO POR EL AUTOR (2026-09-09):** se la abrió un vidrio del parabrisas la última noche que liberó solo un convoy de niños, sacando a un niño por la ventanilla, antes de caer en prisión — no la pelea de cantina que dice el rumor del barrio. Ya no es diseño provisional. Es de las pocas cosas que cuenta de sí mismo sin que se las pidan, y se la cuenta a Chiara la noche del jacuzzi ([[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/25_Libros_Abiertos|Capítulo 25]]).
...
**Sobre la calavera.** La primera vez que alguien se la nombra, la conversación es ésta:
...
**El estilo cambia con el libro.** En la etapa temprana: chaqueta de mezclilla con cuello de borrego **sin camisa debajo**. Es un marcador de época — cuando el atuendo de Kal empiece a cambiar, el lector tiene que poder fechar en qué momento del ascenso está sin que nadie se lo diga.

**Y, desde cierta Navidad, un collar.** Una placa de oro grabada: **RETORNA A CASA**. No se lo quita nunca — ni para trabajar, ni para dormir, ni para meterse a una piscina desangrándose. Es el único objeto de la novela que importa, y para un hombre que casi no usa joyas, llevar algo al cuello ya lo dice todo. Ver [[06_Relationships/Kal_y_Chiara]], "El ritual".
...
![[99_Reference/character_art/Perfil_Kal_Mercer.png|360]]
![[99_Reference/character_art/Kal_Mercer.png|480]]
...
**Uso:** tomar el perfil como apoyo para el rostro y la escena del coche para postura y mezcla de vestuario. Para la etapa temprana sigue disponible [[99_Reference/character_art/Kal_Mercer_cotidiano.png]]; la variante [[99_Reference/character_art/Kal_Mercer_hibrido_negocios_calle.png]] desarrolla la transición de ropa. Ninguna lámina fecha por sí sola esa transición.

**Control de continuidad:** en `Kal_Mercer.png`, cicatriz y arete aparecen del lado anatómico derecho; el canon exige **mejilla y oreja izquierdas**, como en el perfil. No trasladar esa inversión a prosa o ilustraciones futuras. El blackout sigue en el antebrazo derecho. El cuello sin placa sólo sirve para una etapa anterior al regalo de Navidad; después debe conservar **RETORNA A CASA**. Los rótulos y detalles del coche son ambientación gráfica, no datos nuevos del vehículo.
...
Kal se define con una sola palabra, y sólo la ha dicho en voz alta una vez: **camaleón**. No es una pose. Es un mecanismo de supervivencia que instaló a los dieciséis años y ya no supo apagar: entra a una habitación, lee qué necesita esa habitación, y lo es. Con los del barrio es del barrio. Con los abogados es paciente y correcto. Con los militares es seco. Ninguna de esas versiones es falsa, y ése es el problema — Kal no está fingiendo. Está genuinamente disponible para volverse lo que haga falta, y a los cuarenta y un años ya no sabría decir qué queda cuando la habitación está vacía.
...
La formulación exacta del personaje, y la que manda sobre todas las demás:

> **Kal es el hombre que se ofrece de puente para que otros crucen, minimizando el costo para él.**

Las dos mitades importan igual. Se tiende — eso es lo admirable. Y después **quita importancia a lo que le costó tenderse** — eso es la patología. No es modestia ni es aguante: es que si el costo se nombra, alguien podría sentirse en deuda, y entonces tendría gente a la que le debe algo en vez de gente que le debe a él. Prefiere sangrar a que lo cuiden.

Su síntoma verbal es siempre el mismo, y hay que usarlo en toda la novela hasta que duela: **minimiza mientras se desangra.** *Estoy bien. No es nada. Ya está.* Ver [[06_Relationships/Hitos]], H1.

**La otra mitad de la regla, y es la que lo vuelve escribible:**

> **Kal dice la verdad terrible sobre sí mismo sólo cuando no le cuesta nada, y miente sobre sí mismo justo cuando sí cuesta.**

| Nada en juego, una noche buena | *Yo soy la muerte caminando.* |
| Desangrándose en el suelo | *Estoy bien.* |

No es contradicción: cuando hay algo en riesgo, protege — y proteger incluye no dejar que nadie se preocupe por él. Cuando no hay nada en riesgo, **por fin puede ser sincero.** Consecuencia de oficio: **las mejores confesiones de Kal llegan en los momentos más triviales del libro**, nunca en los grandes.

**Y el código que sale de ahí.** Kal termina construyendo buena parte de lo que cree alrededor de una sola idea: **hay cosas que no están en venta.** No es una postura moral abstracta — es la respuesta directa a [[02_Characters/Silas_Crowe]], que sostiene que la lealtad, las personas y el barrio entero tienen precio. Y es autobiografía, porque a Kal lo compraron. Ver [[04_Concepts/Quien_Decide_Quien_Soy]].

**La ironía del nombre.** La calle lo llama *el Gancho* — lo que hace a los demás: los engancha, los remolca, los deja debiéndole. Pero lo que él es de verdad es un puente: lo que hace *por* los demás, a su costa. Nadie en San Aurelio tiene el nombre correcto para él, y la única persona que sabe la diferencia es Chiara. Territorio y relato otra vez: la ciudad le puso un nombre y no es el suyo.

Negocia todo. No por codicia: porque no sabe estar en una situación sin buscar la salida que deja a todos mejor de lo que estaban, incluido él. Es encantador de una manera que no parece técnica y lo es. Tiene un carácter fuerte debajo de una calma que casi nunca se rompe — y las dos o tres veces que se rompe en el libro deben pesar como acontecimientos.

Es extremadamente buen conductor. Es lo único que hace sin calcular.

**Su coche es un Peugeot 106 XSi rojo, reacondicionado** — con el que se les escapa a los policías de San Aurelio en cada persecución. En la calle lo llaman **"el terror de la policía"**, y casi nadie sabe quién va dentro.

> **DISEÑO:** que sea un cochecito barato y no un deportivo es la mitad del personaje: **es habilidad, no dinero.** Y el contraste con [[06_Relationships/Hitos]] H2-a es el arco entero en dos vehículos — la camioneta de lujo **rentada** para impresionarla en la primera cena, contra el Peugeot de verdad en el que aparece la noche en que ella entiende que ya lo eligió. **El disfraz no la ganó. Ser él, sí.**

### El miedo que organiza todo

Kal no tiene miedo al peligro: tiene miedo a que alguien ocupe un sitio permanente en su vida. No porque no sepa querer — al revés. Entiende perfectamente que dejar que alguien importe significa aceptar que se lo pueden llevar, que puede fallarle, que puede necesitarlo, y que a partir de entonces tendrá algo que defender.

Por eso la intimidad le resulta más difícil que cosas objetivamente más peligrosas. Y por eso **proteger a todo el mundo es su solución de compromiso**: es una manera de tener gente sin admitir nunca que la tiene. Si eres el que cuida, nunca eres el que necesita.

**Y la novela le niega la confirmación.** Kal se pasa el libro entero braceado para la pérdida que lo define, y esa pérdida no llega: Chiara no se va, pase lo que pase (regla dura en [[06_Relationships/Kal_y_Chiara]]). Nadie se lo lleva. Su miedo nunca cobra. Eso es lo que lo obliga, muy tarde, a mirar lo que de verdad estaba en riesgo — que no era que lo dejaran, sino en qué se estaba convirtiendo mientras esperaba que lo dejaran.

**Regla de escritura:** Kal no verbaliza nada de esto. Jamás. Su vulnerabilidad funciona por silencios, por decisiones, por quedarse, por gestos pequeños, por respuestas incompletas — y sobre todo por dejar que Chiara vea cosas que nadie más ve. Si un borrador lo tiene explicando su herida, el borrador está mal.

### La fe que respeta

Kal no es tan católico como Chiara. No tiene su educación religiosa, su soltura en una iglesia ni su manera de hablar con Dios.
...
Fuera de casa, Kal no toca a Chiara ni la nombra como suya: la ciudad tiene que seguir sin saber (ver [[06_Relationships/Kal_y_Chiara]], "Los dos frentes y la unión invisible"). Puertas adentro es el hombre que sólo es con ella:
...
- Le devuelve el saludo en italiano — *"ciao, bellissima"*, con acento exagerado y malo a propósito. Ver [[06_Relationships/Kal_y_Chiara]], "El acento que cede, y el 'Ciao' que lo compensa".

**No cambia la regla de escritura:** la ternura es conducta, no discurso. Kal no se pone lírico ni explica lo que siente. Si un borrador lo tiene diciendo cosas tiernas elaboradas, está mal. Ver [[06_Relationships/Kal_y_Chiara]], "El registro privado".
...
Kal fue comprado. No adoptado: comprado, de bebé, a través de una red que movía niños desde el norte de Europa hacia la costa oeste a finales de los noventa. **Su verdadero origen es Noruega.** Los papeles que existen son falsos y él lo sabe desde los veinte. Lo único que puede ser real es una pulsera de hospital de una ciudad que nunca ha visitado.
...
> **CANON DEL AUTOR (2026-08-29):** hay una segunda pieza, además de la pulsera — una caja de madera con algo grabado en runas nórdicas, escondida desde niño en un conducto de aire de [[05_Locations/La_Casa]]. Kal la recupera en [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/10_El_Loft_Del_Soltero]] sin abrirla y la guarda en el maletero. **No vuelve a aparecer ni a mencionarse hasta la Parte 3** — ver [[12_Craft_Policies/revelations/SAGA_LEVEL]].

### La casa que no era una casa

Lo criaron Dale y Ruth Mercer, en el barrio de la Almendra. Ruth quería un hijo y no podía tenerlo; Dale nunca lo quiso y nunca fingió lo contrario, pero le enseñó todo lo útil que Kal sabe: abrir un coche sin llave, leer a un hombre antes de que hable, no deber nunca dinero a nadie que sepa dónde duermes.

Dale jugaba — no por diversión, sino porque necesitaba que algo en su vida siguiera siendo incierto. Apostaba y pedía prestado a **[[02_Characters/Silas_Crowe]]**, mucho antes de que el barrio entero conociera al Tasador por ese apodo: para Dale, Crowe era sólo el hombre que prestaba fácil y cobraba después. Cuando perdía más de lo que podía cubrir, la casa se volvía un lugar donde Ruth y Kal aprendían a leer su humor antes de que abriera la puerta. Dale no golpeaba a Kal por Kal: golpeaba por lo que acababa de perder.

Dale se fue cuando Kal tenía quince años, arrastrado por esa misma deuda que no era de negocio: Crowe terminó cobrándosela poniéndolo a trabajar para él en algo que salió mal, y Dale terminó preso. Ruth aguantó dos años más, sola con lo que quedaba. Kal se quedó solo a los diecisiete en una casa que ya no podía pagar. Para el inicio de la novela, Ruth y Dale están enterrados en [[05_Locations/Cementerio_Santa_Lucia]]; Kal visita a Ruth con una rosa blanca tomada del ramo de Michael y evita tocar la tumba de Dale.

**CANON DEL AUTOR (2026-08-26) — el recuerdo que Kal guarda de los dos juntos.** Ruth fue madre amorosa, pero se fue perdiendo con el juego de Dale — cuidándolo, cubriéndolo, persiguiéndolo — hasta quedar como la sombra de la mujer que había sido. **El único recuerdo nítido que Kal tiene de sus dos padres en la misma escena es el día que arrestaron a Dale: y Ruth arrastrándose detrás de él, humillándose.** Esa imagen — no una declaración, no una explicación — es la que carga cuando piensa en lo que es una familia rota.

> **RESUELTO DE DISEÑO (2026-08-25):** qué se llevó a Ruth y cuánto vio Kal: la ludopatía de Dale y su deuda con Crowe, que derivó en golpes a Ruth y a Kal y terminó con Dale preso. Es una segunda capa, autobiográfica, de por qué Kal aborrece el juego de azar — se suma a "lo compraron de bebé" (más abajo), no la reemplaza. Se filtra en conducta (regla 9 de [[00_Biblia/Principios_Narrativos]]).
>
...
> **DETALLE CONCRETO (2026-08-29):** la casa de Dale y Ruth ([[05_Locations/La_Casa]]) tiene un balcón trasero desde donde se ve [[05_Locations/Comisaria_De_Hale_Valley]]. Ahí, a los quince años, descalzo, Kal ve a Ruth corriendo detrás del auto y colgándose de las piernas de Dale mientras se lo llevan — Dale no la mira, pero incluso esposado y vencido encuentra la forma de exigirle algo con los ojos, y ella lo suelta obedeciendo. Es la última vez que Kal ve a su padre con vida. **Esa misma noche, en la celda, Dale se ahorca con su propia ropa.** Ruth no sobrevive mucho más: dos años de deterioro por opioides — empieza con pastillas para dormir — hasta que Kal, a los diecisiete, vuelve una tarde y el silencio de la casa se lo dice todo antes de entrar. Esta escena se dramatiza, en solitario y sin una sola palabra dicha en voz alta, en [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/10_El_Loft_Del_Soltero]] — Kal regresa a la casa vacía para venderla remodelada y el balcón lo detiene más que cualquier otro cuarto. **No rompe la restricción de arriba:** ahí no habla con nadie; es memoria pura, para el lector solo.

### El recuerdo bueno — los panqueques del sábado

**CANON DEL AUTOR (2026-09-10).** No contradice la regla de arriba: aquélla es la única escena con **los dos** juntos. Ésta es sólo con Ruth, los sábados que Dale no estaba (jugando, casi siempre). Ruth hacía panqueques con tocino y miel y tarareaba, mal, una canción que nunca le dijo de dónde había sacado — se comía la mitad de las palabras, y Kal la tarareaba con ella sin entender ninguna. **La canción queda sin nombre ni idioma explícito a propósito** — coherente con "sembrar con rasgos nórdicos, no confirmar Noruega todavía" (ver "El origen que no está", arriba). Cuando Kal le preguntó una vez qué decía, Ruth le contestó que no importaba: importaba que supiera que alguien la cantaba pensando en él. Y remataba con lo que Kal entiende como la filosofía entera de Ruth:

> Lo único que de verdad tenemos es quiénes somos en el mundo. Y quiénes somos no es otra cosa que cómo elegimos dirigir la vida. Todo lo demás se presta.

Kal se lo cuenta a Chiara por primera vez en [[11_Books/Book_01_Seda_y_Polvora/Part_01_Dos_Mundos/25_Libros_Abiertos|Cap. 26]] (el jacuzzi), justo después de que ella le cite la última frase de Marta — las dos máximas quedan una al lado de la otra, sin que el narrador lo subraye. **No rompe** la restricción de H11 sobre el recuerdo del arresto: es un recuerdo distinto, y sigue sin dramatizarse la escena del arresto en ningún otro sitio.
...
> **DECANONIZADO (2026-08-23):** esta ficha decía antes que Kal salió herido de una mina y que un sanitario llamado Michael Grayson murió sacándolo. Era invención del agente. **Sustituido por el canon del autor**, abajo.

### El convoy — lo que rompe todo

**CANON DEL AUTOR (2026-08-23).**

Kal descubre que su general, **[[02_Characters/Warren_Halbrook]]**, está usando operaciones clandestinas para **mover niños destinados a ser vendidos**.

Al principio creyó que era contrabando corriente. Hasta que entendió qué significaba realmente cierta *mercancía*. **Ahí se le acabó la lealtad.**

En su última operación, **Kal libera el convoy.**
...
Este origen no es sólo trasfondo: es el motivo por el que Kal reacciona **desproporcionadamente** la tarde en que sorprende a un menor buscando en [[03_Factions/Almendra_Towing|El Patio]] a alguien que el chico sólo sabe nombrar como **"Roma Atrii"** — sin saber, y sin que Kal lo sepa tampoco, que es el nombre en clave que [[02_Characters/Chiara_Bellandi]] usa para él. Ver [[03_Factions/Red_Civil_de_Chiara]], "El cifrado dentro del cifrado". Nadie estuvo herido. Nadie estuvo en peligro real. Y aun así llega dispuesto a romper el arreglo entero con ella.
...
Cuando va a reclamarle a Chiara, en el casino, ella se disculpa sin pelear — pero deja algo abierto: le dice que de ahora en más trae ella misma lo que tenga que llegarle, y cuando Kal pregunta qué significa "Roma Atrii", ella se lo niega con un *"todavía no"* que no es un no. Boceto completo de la escena en [[07_Ideas/El_Chico_Del_Patio]].

### La prisión, y Nadir

En prisión conoce a **Nadir Amrani** — que en ese momento **no era soldado ni criminal profesional, sino un mercader acusado de robo.** Dos hombres encerrados por razones completamente distintas.

**Y fue Nadir quien lo ayudó a salir.**

En agradecimiento, Kal lo ayudó a **entrar a Estados Unidos**, consiguiéndole papeles **con ayuda de [[02_Characters/Anya_Voronina]]**, una contacto rusa de su época de Afganistán. Los dos regresan a San Aurelio.

> **DISEÑO:** ésta es la única relación importante de la vida de Kal donde **el favor lo recibió él primero.** Todas las demás empiezan con Kal dando; ésta empieza con Kal debiendo — y pagándolo entero. Por eso Nadir no le debe nada, y por eso es su mejor amigo.
...
Y Kal vuelve en un momento emocionalmente terrible: **su viejo amigo del ejército [[02_Characters/Michael_Grayson|Michael Grayson]]**, ya retirado, se está muriendo de cáncer.

**[[02_Characters/Marisol_Grayson]]** es su hija. Kal se hace cargo de ella. Hoy **estudia y reside en la universidad.**

> **RESUELTO (2026-08-23):** ficha propia creada en [[02_Characters/Marisol_Grayson]]. Función narrativa: es la única persona a la que Kal protege sin obtener nada, y por lo tanto el único termómetro fiable de en qué se está convirtiendo. Y es quien acaba diciéndole en la cara que protegerla no era lo mismo que dejarla decidir.
>
> Que **viva en la universidad y no en la casa** pesa: Kal la sacó del barrio. Le dio exactamente lo que a él nadie le dio — un sitio donde nadie sabe de dónde viene — y el precio es que casi no la ve.

### La cadena completa, y por qué el Kal que vuelve no es "un veterano que regresó"

> **perdió su carrera → perdió su fe en la institución → pasó por prisión → encontró a Nadir → volvió a casa → y casi de inmediato tuvo que despedirse de otro de los pocos hombres de su vida militar que todavía significaban algo bueno.**

Ésa es la cadena, y explica casi todo el carácter posterior: por qué no cree en instituciones, por qué construye la suya, por qué protege a todo el mundo, y por qué la lealtad que da es tan cara y tan silenciosa.

### La fachada — "un hombre de negocios intachable"

**CANON (ver [[06_Relationships/Hitos]], H2).** Al volver del ejército, Kal se plantea algo deliberado: **construirse una cara pública impecable.** Un empresario correcto, de esos con los que da gusto cerrar tratos. Usa lo único que sabe hacer de nacimiento — adaptarse y convencer — para encadenar negocios mutuamente beneficiosos y acumular reputación limpia.

Y no es vanidad. Tiene una función exacta: **que el barrio pueda empezar a moverse sin llamar la atención**, porque ahora hay una explicación de por dónde entra el dinero. *Lo trajeron los negocios de Kal.*

Lo que esto revela del personaje: **Kal entiende el relato desde el primer día.** Se construyó una versión pública de sí mismo y vive adentro. No es ingenuo sobre cómo funciona la narrativa — es la prueba viviente. Lo que le falta no es la idea: es el **alcance**. Corre una sola versión, la suya, a mano, una habitación a la vez. Ver [[04_Concepts/El_Territorio_y_El_Relato]].

### El patio

Abre un taller de automóviles **en la vieja bodega de su padre** — la única cosa que Dale Mercer dejó atrás al irse, y el cimiento sobre el que Kal levanta todo lo demás. La ironía no se comenta nunca en el texto.

> **CAMBIO DE CANON (2026-08-23):** esta ficha decía antes que compró un patio de grúas quebrado en subasta. Sustituido por canon del autor. Se conserva el nombre [[03_Factions/Almendra_Towing]] y el barrio.

Las grúas llegan **después**, como crecimiento natural del taller. Y ahí está el hallazgo que lo cambia todo: **una grúa es el único vehículo de San Aurelio que puede llevarse cualquier cosa de cualquier calle a plena luz del día sin que nadie pregunte nada.** Ver [[00_Biblia/Reglas_del_Mundo]], regla 1.

> **DISEÑO:** que las grúas lleguen después es mejor que tenerlas desde el principio, porque convierte el descubrimiento en **una escena** en vez de una condición inicial. Que sea ella quien lo vea antes que él es la propuesta que sigue en pie.

---

## Método: cómo crece

Kal no conquista. **Se vuelve necesario.** Las cuatro fases están en [[00_Biblia/Reglas_del_Mundo]] (regla 2) y son el esqueleto de cada arco de expansión de la novela.
...
En [[04_Concepts/La_Guerra_de_los_Tres|la Guerra de los Tres, en Voto de Ceniza]], esa red no puede adquirir apariencia de milicia Mercer. Kal conserva su fachada de empresario, dueño de Almendra Towing, inversionista y operador local. Sus hombres aparecen desde fuera como bandas, trabajadores, contactos, aliados y grupos con intereses coincidentes; no usan uniformes, insignias ni un lenguaje común que vuelva demostrable el mapa completo.

**Lo que no ve:** que el mismo mecanismo que lo hace querible es el que lo va a dejar solo. Todos le deben algo. Nadie está con él gratis. Y el día que alguien se quede por decisión propia, Kal no va a saber creerlo.
...
- **Nunca deja que le regalen nada.** Convierte cualquier regalo en transacción en menos de un minuto — devuelve el gesto, paga la cuenta, hace un favor mayor. No es orgullo: es que deber algo a alguien lo aterra más que perderlo.
  - **La excepción, y es una sola en toda su vida adulta: el collar.** Se lo quedó sin devolver nada. La escena en que lo acepta es un hito obligatorio, y es el momento en que Chiara gana algo que nadie más ha ganado. Ver [[06_Relationships/Hitos]].
- **Conduce él.** Siempre.
...
- **La violencia es lo último.** Vive en un mundo que la contiene, pero para Kal es la herramienta que queda cuando ya no hay otras — nunca un sustituto de carácter. Su terquedad humana es justamente lo que lo distingue en esta ciudad.
- **Su palabra vale.** Es lo único que heredó sin que nadie se lo diera. Si Kal dice que va a hacer algo, ocurre, y esa reputación es la mitad de su poder real.
...
Guardarraíles. Si un borrador lo empuja hacia aquí, está mal escrito:

- **No es un hombre frío.** Tiene humor, ternura, paciencia y aburrimiento. Protege sus emociones; no carece de ellas. La diferencia es todo.
- **No es su trauma.** No existe únicamente como pasado herido, y no hay escena donde su función sea sufrir.
- **No es posesivo ni violento por defecto.** No trata mal a Chiara para demostrar que está roto.
- **No explica sus heridas.** Ver la regla de escritura arriba.
...
Mientras Chiara está inconsciente en [[06_Relationships/Hitos]], H12, Kal investiga por su cuenta quién la atacó. No encuentra nada — ninguna pista llega a ningún lado, y tiene que aceptarlo sin resolverlo. Queda guardado, no cerrado.
...
Chiara se lo cuenta después de H1, sólo cuando él está fuera de peligro y vuelve cierta normalidad doméstica. Su reacción queda por redactar, pero el patrón está fijado: shock, procesamiento, emoción difícil de verbalizar y desplazamiento inmediato hacia seguridad, médicos, casa, trabajo, dinero y futuro. Kal intenta convertir *voy a ser padre* en algo que pueda resolver.
...
Elenna cambia después el propósito de su ambición. Dario construye un sistema donde todo debe pasar por Dario; tras [[06_Relationships/Hitos#H22 — Los primeros pasos|H22]], Kal empieza a construir uno donde cada vez menos cosas necesiten pasar por él. No se retira de inmediato: profesionaliza, delega y crea redundancias para que la estructura sobreviva a su ausencia.
...
- [[04_Concepts/Fe_y_Velas]] — el ritual de las velas: Chiara pide que vuelva; Kal aprende a respetar esa forma de miedo.
- [[05_Locations/Iglesia_Santa_Lucia]] — el lugar donde Kal, en sus peores momentos, prende una vela y se sienta sin hablar.
...
- [[03_Factions/Cross_River_Consolidated]] — holding de activos donde Kal no debe aparecer como beneficiario visible.
...
- **[[02_Characters/Warren_Halbrook]]** — **su verdugo.** El general cuya red descubrió, y para quien Kal no es un héroe sino un desertor que sabe demasiado.
...
- **[[02_Characters/Dario_Varek]]** — la cima del poder criminal de la ciudad. **Kal entra a su organización** en [[06_Relationships/Hitos]], H6 — para proteger a Chiara, y para comérsela desde dentro.
...
- **[[02_Characters/Anya_Voronina]]** — contacto rusa y amor pasado de la época de Afganistán. Consiguió los papeles de Nadir y representa la versión de Kal que todavía no creía en el amor auténtico.
- **[[02_Characters/Daniel_Hayes|Daniel "Danny" Hayes]]** — del barrio, dueño del perro al que Kal le enseñó a dar la pata. El otro testigo de H2-a.
- **[[02_Characters/Marisol_Grayson]]** — hija de [[02_Characters/Michael_Grayson]]. Kal se hizo cargo de ella cuando su padre murió. Estudia y reside en la universidad. **Su conciencia con piernas.**
- **[[02_Characters/Michael_Grayson]]** (†) — viejo amigo del ejército, retirado. Muere de cáncer poco después de que Kal vuelva. Le deja a su hija.
...
> **PENDIENTE:** ¿mata alguien Kal en esta novela, y en qué página? La respuesta define el género real del libro.

> **PENDIENTE, ESTRUCTURAL (2026-08-29):** el libro se está leyendo casi entero desde el punto de vista de Chiara — su método, su expansión, sus decisiones. El lado criminal de Kal (más allá de lo legítimo: Almendra Towing, el taller) casi no se ha dramatizado en escena propia. El lector sabe que existe (El Patio, la red, el pasado que "administra") pero casi nunca lo ve operar directamente, con Kal como punto de vista y sin que Chiara sea el filtro. Falta al menos una escena — quizás varias, en capítulos futuros — donde el lector esté con Kal del lado ilegal de su vida sin ella presente ni como excusa narrativa. Anotado también en [[98_Agent_Handoff/PENDING]].
