...
**Políticamente correcto y criminalmente despiadado.** Ésas son las dos mitades y no se contradicen: es un hombre de formas impecables cuya corrección es el instrumento con el que hace lo que hace. Nunca levanta la voz, nunca dice nada citable, nunca queda mal en una habitación.

Egocéntrico. Y **misógino disimulado** — lo importante es *disimulado*: jamás dirá nada que pueda repetirse en su contra. Se le nota en cómo asigna valor, no en cómo habla.
...
## Su base de poder, y las dos relaciones que lo definen
...
>
> Es también su versión de la pregunta del libro: *el poder pertenece a quien puede tomarlo y conservarlo* — y ahora mismo la tiene a ella. Ver [[04_Concepts/Quien_Decide_Quien_Soy]].
