...
La resolución no consiste en conquistar mejor San Aurelio. Consiste en descubrir que el hogar nunca fue el imperio: fue la familia que construyeron dentro de él y que después deben elegir por encima de él.

## Mecánica causal de la trilogía
...
El Libro I contiene, en términos de la arquitectura anterior, el material de **encuentro + construcción**.

Debe desarrollar de forma suficiente:
...
La función de esta coalición es producir el primer conflicto que ya no puede leerse como incidente aislado.
...
No necesita presentación pública, discurso ni exposición extensa.
...
**Guerra, sacrificio, ausencia y decisión de salir.**

La Guerra de los Tres pertenece principalmente a este libro.
...
`temer que todo lo amado desaparezca -> elegir una ausencia para salvar -> sobrevivir al precio de esa elección`

En el Libro I la ausencia le sucede.

En el Libro II Chiara tiene que hacer algo peor: **participar conscientemente en la desaparición de su propia hija de su vida cotidiana**.
...
El libro **no abre en guerra total**.

Comienza con consecuencias, anomalías y señales posteriores a H1:
...
Después debe existir un detonante concreto —todavía pendiente— que vuelva inaceptable mantener su existencia dentro del tablero.

Resultado obligatorio:

> **Estado público: Elenna Mercer ha muerto.**  
> **Estado real: Elenna Mercer vive bajo la identidad de resguardo Elenna Serra.**
...
- presencia física;
- una parte irrepetible de la infancia de su hija;

para conservarla viva.

La separación debe durar y respirar. Las fotografías siguen siendo escasas y se destruyen después de verlas.

## H22 — Los primeros pasos

> **NUEVA UBICACIÓN CANÓNICA:** H22 pertenece a *Voto de Ceniza*. La antigua ubicación después del cierre de la Guerra de los Tres queda supersedida.
...
No pueden ejecutarlo todavía porque la guerra sigue abierta.

Esta colocación es regla dura porque impide que la decisión de marcharse nazca del miedo posterior al atentado de Chiara. **Ellos eligen a Elenna antes de Santa Lucía.**
...
## Clímax real — operación final de Halbrook

Halbrook ejecuta una sola operación con dos frentes físicos y tres golpes relacionales.
...
Después de la montaña y Santa Lucía:
...
La decisión pertenece al Libro II. La ejecución pertenece al Libro III.
...
- otros decidan;
- otros se equivoquen;
- las rutas funcionen sin él;
- El Patio deje de ser sinónimo de Mercer;
- la ciudad sobreviva a su ausencia.

La culminación de su arco es aceptar que **ser necesario no es lo mismo que ser amado**.

## Arco de Chiara

Movimiento esencial:

`hacer desaparecer para proteger -> rechazar que otros definan su pertenencia -> terminar la ausencia`

Il Consorzio intenta decidir qué significa su sangre, su apellido y la legitimidad de lo que ha construido.

Chiara no completa su arco convirtiéndose en heredera de una corona italiana ni obteniendo reconocimiento de la institución. Lo completa rechazando la premisa de que necesita ese reconocimiento.
...
La caída de Dario deja a Il Consorzio con mayor libertad para presionar, reconocer, reorganizar o disputar el espacio de San Aurelio.

Chiara enfrenta la institución que pretende definirla como Ardizzone y decidir qué forma de poder merece reconocimiento.

Corrado puede aportar conocimiento, contexto y una relación personal imposible de ignorar. **No sustituye a Chiara como protagonista del conflicto ni regresa para ponerla en un trono.**

Su arco debe poder terminar comprendiendo que la victoria de su hija no es heredar posición, sino poder abandonar la obligación de ocuparla.
...
> **No sostenerlo con el cuerpo. Construirlo para poder dejar de sostenerlo.**

## Resolución

Meridian cierra el cerco.

Il Consorzio pierde la capacidad de decidir quién debe ser Chiara.
...
Casa modesta azul, molduras blancas, jardín.
...
`construir -> proteger -> soltar`

O, en su herida más profunda:

> **Inicio:** “Si me hago indispensable, nadie podrá dejarme.”  
> **Final:** “Si los amo bien, no deberían necesitar que yo sea indispensable.”
...
# Bisagras obligatorias entre libros
...
- duración exacta de la separación;
- momento exacto de H22 dentro del Libro II, más allá de sus anclas relativas;
